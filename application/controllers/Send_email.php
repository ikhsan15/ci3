...
class Send_email extends CI_Controller {
  ...
  // Konfigurasi email
    $config = [
      ...
      'smtp_user' => 'sansbuster@gmail.com',  // Email gmail
      'smtp_pass'   => 'sandriilove15',  // Password gmail
      'smtp_crypto' => 'ssl',
      'smtp_port'   => 25,
      'crlf'    => "\r\n",
      'newline' => "\r\n"
  ...
  ini_set('sendmail_from', "email@domain.com");
    ...
    $this->email->from('sansbuster@gmail.com', 'sans.com');

    // Email penerima
    $this->email->to('ikhsan15nur@gmail.com'); // Ganti dengan email tujuan
